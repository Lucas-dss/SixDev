            ...
            <div class="container-formulario">
                <form action="cadastro_ven.php" method="POST" id="form">
                    ...
                    <div class="formulario-bloco">
                        ...
                        <input type="text" name="nome_vende" id="nome_vende" minlength="4" maxlength="50" placeholder="Nome" autofocus required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="tel_vende">Telefone</label>
                        <input type="tel" name="tel_vende" id="tel_vende" minlength="11" maxlength="11" placeholder="Telefone" required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="cpf_vende">CPF</label>
                        <input type="tel" name="cpf_vende" id="cpf_vende" minlength="11" maxlength="11" placeholder="CPF" required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="end_vende">Endereço</label>
                        <input type="text" name="end_vende" id="end_vende" minlength="7" maxlength="100" placeholder="Endereço" required>
                    </div>
