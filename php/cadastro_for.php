            ...
            <div class="container-formulario">
                <form action="cadastro_for.php" method="POST">
                    ...
                    <div class="formulario-bloco">
                        ...
                        <input type="text" name="nome_for" id="idnome" minlength="4" maxlength="50" placeholder="Nome" autofocus required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="tel_for">Telefone</label>
                        <input type="tel" name="tel_for" id="idtelefone" minlength="11" maxlength="11" placeholder="Telefone" required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="end_for">Endereço</label>
                        <input type="text" name="end_for" id="idend" minlength="7" maxlength="100" placeholder="Endereço" required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="cnpj_for">CNPJ</label>
                        <input type="tel" name="cnpj_for" id="idcnpj" minlength="14" maxlength="14" placeholder="CNPJ" required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="custo_for">Custo Unitário</label>
                        <input type="tel" name="custo_for" id="idcusto" minlength="1" maxlength="5" placeholder="Custo Unitário" required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="prod">Produto Vendido</label>
                        <input type="text" name="prod" id="idprod" minlength="4" maxlength="50" placeholder="Produto Vendido" required>
                    </div>
