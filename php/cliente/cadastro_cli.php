            ...
            <div class="container-formulario">
                <form action="cadastro_cli.php" method="POST" id="form">
                    ...
                    <div class="formulario-bloco">
                        ...
                        <input type="text" name="nome_cliente" id="nome_cliente" minlength="4" maxlength="50" placeholder="Nome" autofocus required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="tel">Telefone</label>
                        <input type="tel" name="tel" id="tel" minlength="11" maxlength="11" placeholder="Telefone" required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="cpf">CPF</label>
                        <input type="tel" name="cpf" id="cpf" minlength="11" maxlength="11" placeholder="CPF" required>
                    </div>
                    <div class="formulario-bloco">
                        <label for="end">Endereço</label>
                        <input type="text" name="end" id="end" minlength="7" maxlength="100" placeholder="Endereço" required>
                    </div>
